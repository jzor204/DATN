...
type TaskData struct {
	...
	Progress    int        `json:"progress" example:"35"`
	AssigneeID  *uint      `json:"assignee_id" example:"2"`
	Deadline    *time.Time `json:"deadline" example:"2026-06-15T09:00:00Z"`
...
type ChecklistItemData struct {
	ID        uint      `json:"id" example:"1"`
	TaskID    uint      `json:"task_id" example:"1"`
	Title     string    `json:"title" example:"Dang nhap user"`
...
type ChecklistItemMutationPayload struct {
	Item     ChecklistItemData `json:"item"`
	Progress int               `json:"progress" example:"50"`
}

type ChecklistItemMutationSuccessResponse struct {
	Success bool                         `json:"success" example:"true"`
	Message string                       `json:"message" example:"update checklist item success"`
	Data    ChecklistItemMutationPayload `json:"data"`
}

type ChecklistItemListSuccessResponse struct {
	Success bool                `json:"success" example:"true"`
	Message string              `json:"message" example:"get checklist success"`
	Data    []ChecklistItemData `json:"data"`
}
